...
from experiments.full_mim.model import UNetWithMIM
...
def _train(
    ...
    dm = DataModule(preprocessed, dataset, plan)
    lm = UNetWithMIM.from_plan(plan, UMambaEnc, 0.6, deep_supervision=True)
    tr = L.Trainer(
